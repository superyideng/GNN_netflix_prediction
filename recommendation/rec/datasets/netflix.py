...
class DataRead(object):
    def __init__(self, directory):
        ...
        # read movies
        with open(os.path.join(directory, 'movies_1000.dat'), encoding='latin1') as f:
            for l in f:
        ...
        ratings = ratings[ratings['movie_id'].isin(self.movies.index)]
        ...
        movie_count = self.ratings['movie_id'].value_counts()
        movie_count.name = 'movie_count'
        self.ratings = self.ratings.join(movie_count, on='movie_id')
