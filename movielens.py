...
class MovieLens(object):
    def __init__(self, directory):
        ...
        # read movies
        with open(os.path.join(directory, 'movies.dat')) as f:
            for l in f:
                ...
                movies.append(data)
                self.movies = (pd.DataFrame(movies).set_index('id').fillna(False).astype({'year': 'category'}))
